...
--
-- v5.86: FIX `zenx login` "gak nemu client" padahal client lagi login akun
            ...
            if pengisi and akun2pkg[pengisi] and psLink and psLink ~= "" then
                ...
                if _G.__hactLastLink[pkg] ~= psLink then
                    ...
                    if tsAge >= 30 then
                        ...
                        TERAKHIR_BUKA[pkg] = os.time()   -- v9.381: biar FORCE sticky gak buka dobel (hactoto)
                        KICK_DIURUS["tembak_ts:" .. pkg] = os.time()
                    else
                        _G.__hactRejoin = _G.__hactRejoin or {}
                        _G.__hactRejoin[pkg] = true
                        info(("[hactoto] %s target GANTI (baru dibuka %ds) -> tembak 30s lagi"):format(pengisi, tsAge))
                    end
                end
                n = n + 1
                ...
                do
                    ...
                    for line in raw:gmatch("[^\n]+") do
                        ...
                        if nama and ts then
                            ...
                            -- v9.418: DBG-SHECK SELALU log (sementara, diagnosa sheckles 0). Nanti balik gated.
                    ...
                    if (now - (bekuSejak[pkg] or 0)) >= 90 then
                        ...
                        if g < 30 * 1024 then
                            ...
                            if kead == "dead" or kead == "ban" then
                                ...
                                open_one(cfg, pkg, mapLink[pkg], "nyangkut-home", true)   -- am start, TANPA kill
                                os.execute("sleep 3")
                                refresh_status(); lastStatusCek = os.time()
                                gambar_tabel(isi)
                            end
                ...
                if akun and not lewatiCaptcha then
                    ...
                    elseif diem and diem > (ts and math.min(ambangDc, ambang)
                        ...
                        elseif diem > ambang then
                            ...
                            open_one(cfg, pkg, mapLink[pkg], "auto-rejoin-offlama", true)   -- buka lagi ke PS-nya
...
if PERINTAH == "daftar-cek" then
    ...
    local function jalankan_daftar_cek()
        ...
        if rng == "" then
            err("Cara pakai:  zenx daftar-cek <client>")
            info("   contoh:  zenx daftar-cek 1   -> dump UI form daftar client ke-1")
        ...
        info("Kirim hasil ini -- dari sini dibikin auto-isi (zenx daftar).")
...
if PERINTAH == "home" then
    ...
    if rng == "" then
        ...
        info("   contoh:  zenx home 1-5   -> client ke-1..5 balik home + grid")
...
if PERINTAH == "login" then
    ...
    if cookie and cookie:find("_|WARNING") then
        ...
        -- Ketangkep di lapangan: `zenx login fifinx_7 client` gagal padahal
