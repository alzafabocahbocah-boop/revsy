...
case "$PRESET" in
    *arceus*)
        ...
        case "$PRESET" in
            ...
            leveling-arceus)         RONIHUB_SC="leveling" ;;
            leveling-arceus-[1-9])   RONIHUB_SC="leveling" ;;
            leveling-arceus-[1-9]-market)  RONIHUB_SC="leveling" ;;
